...
SECRET_KEY = 'django-insecure-!ma--q-mwm@pli4mt_f1a$-f6gz2ub-m_su2kp_7a@p+5#ohv1'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000", # React sunucumuzun adresi
]
...
# backend/settings.py dosyasının en altına ekle
